                          ...
                          <Row>
                              <Col lg="6">
                                  <div className="mb-3">
                                      ...
                                      <Input type="text"  className="form-control" id="basicpill-firstname-input1" value={fullname} onChange={(e) =>setfullname(e.target.value)} disabled={true}/>
                                  </div>
                              </Col>
                              <Col lg="6">
                                  <div className="mb-3">
                                      <Label className="form-label" htmlFor="basicpill-lastname-input2">Adresse e-mail</Label>
                                      <Input type="text"  className="form-control" id="basicpill-lastname-input2" value={Email} onChange={(e) =>setEmail(e.target.value)} disabled={true} />
                                  </div>
                              </Col>
                          ...
                          <Row>
                              <Col lg="6">
                                  <div className="mb-3">
                                      ...
                                      <Input type="text" className="form-control" id="basicpill-phoneno-input3" onChange={(e) =>settel(e.target.value)} value={tel} disabled/>
                                  </div>
                              </Col>
                              <Col lg="6">
                                  <div className="mb-3">
                          ...
                          <Row>
                              <Col lg="12">
                                  <div className="mb-3">
                                      ...
                                      <textarea id="basicpill-address-input1" className="form-control" rows="2" onChange={(e) =>setadr_res(e.target.value)} value={adr_res} disabled={true}></textarea>
                                  </div>
                              </Col>
                          </Row>
                        </Row>
                            ...
                            <Row>
                                <Col lg="12">
                                    <div className="mb-3">
                                        ...
                                        <textarea id="basicpill-address-input1" className="form-control" rows="2" onChange={(e) =>{setadr_ferm(e.target.value)}} value={adr_ferm} disabled={true}></textarea>
                                    </div>
                                </Col>
